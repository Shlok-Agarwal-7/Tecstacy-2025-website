...
export const Navbar = () => {
  ...
  return (
    <div>
      ...
      {mobileMenuOpen && (
  <motion.div
    className="md:hidden bg-black fixed top-[65px] left-0 w-full max-h-[80vh] z-50 overflow-y-auto shadow-lg"
  ...
  >
    <div className="container mx-auto px-6 py-4 space-y-4">
      ...
      <Link href="/Coordinators" className="text-gray-100 block">
        COORDS
      </Link>
      <Link href="/#events" className="text-gray-100 block">
        EVENTS
      </Link>
    </div>
  </motion.div>
